...
| **`derrick.ui.DockerRunnerHelper`** | Remains external constrained runner (`docker` CLI only for `script_exec`; see [adr-bun-script-runtime.md](adr-bun-script-runtime.md)) |
