...
| **P1** | partial | Structure wire types (`AppLayerServices/`); AgentService XPC; bootstrap+DB; UI ensure-up; **turn stream via XPC**; local `ConversationModel` drives chat with policy/MCP XPC clients |
