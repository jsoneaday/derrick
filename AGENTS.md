...
You are working on a Desktop Agent Harness using the newest Native Apple development technologies, Swift 6+, XCode 27+ and MacOS 27+.
...
- **Script runtime is Docker + Bun only** (`DockerRunnerHelper` + `DockerNetworkContainerPool`). TypeScript syntax is used to help models understand the types available.
