...
// MARK: - Modal buttons share the HostUI control kit (one library for app + plugins)

struct ModalPrimaryButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        HostUIPrimaryButtonStyle().makeBody(configuration: configuration)
    }
}

struct ModalSecondaryButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        HostUISecondaryButtonStyle().makeBody(configuration: configuration)
    }
}
