...
public enum PromptResources {
    ...
    public static func webCrawlerSkill(from resourceRoot: URL? = nil) throws -> String {
        try load(named: "web_crawler_skill", from: resourceRoot)
    }

    public static func webSearchSkill(from resourceRoot: URL? = nil) throws -> String {
        try load(named: "web_search_skill", from: resourceRoot)
    }
...
public enum PromptResourcesError: Error, Equatable, LocalizedError, Sendable {
